...
# Tải hình ảnh thanh trượt và nút trượt
slider_image = pygame.image.load('Image/Slider.png')  
slider_image = pygame.transform.scale(slider_image, (280, 30)) 
button_image = pygame.image.load('Image/Dragger.png')  # Hình ảnh cho nút trượt
button_image = pygame.transform.scale(button_image, (30, 50))  # Điều chỉnh kích thước nút trượt nếu cần
...
def draw_difficulty_slider(surface, x, y, width, height, min_value, max_value, current_value):
    ...
    # Vẽ hình ảnh nút trượt
    surface.blit(button_image, (slider_x - 10, y - 10))  # Đặt nút trượt tại vị trí tương ứng
